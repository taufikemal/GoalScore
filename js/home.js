...
const eplmatch = () =>{
  ...
  .then((data) =>{
    ...
    document.getElementById('card-league-img').src = `./assets/img/leaguehome/${result[0].strLeague}.png`
    ...
    document.getElementById('card-score1').innerHTML = `${result[0].intHomeScore} : ${result[0].intAwayScore}`
    document.getElementById('card-date1').innerHTML = result[0].dateEvent
